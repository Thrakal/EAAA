...
class MySQL {
    ...
    private $password = "1234FEDCBA"; // Change to the admins password of the server
    private $database = "dating_website"; // Change to the name of the database you would like to connect to on the server
